...
- **`attack-surface-ai/`** - Attack Surface AI tool
- **`workos/`** - WorkOS project
- **`logcopilot/`**, **`pentestgpt/`**, **`surfaceai/`**, **`vpc-guardian/`** - Security tools
- **`smb-security-suite/`** - Unified security suite
